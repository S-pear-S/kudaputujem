...
API ne zna za HTML. Posle ADR 0001 oba sloja žive u istom Python procesu/repou i
uvoze ove modele direktno odavde — nema više paralelne kopije u drugom jeziku.
